...
// var color1 = d3.scale.threshold()
//   .domain([10000, 100000, 500000, 1000000, 5000000, 10000000, 50000000, 100000000, 500000000, 1500000000, 1700000000])
//   .range(["rgb(255, 240, 220)", "rgb(255, 215, 180)", "rgb(255, 190, 140)", "rgb(255, 165, 100)", "rgb(255, 140, 60)", "rgb(255, 115, 20)", "rgb(235, 100, 0)", "rgb(205, 85, 0)", "rgb(175, 70, 0)", "rgb(145, 55, 0)", "rgb(255, 165, 0)"]);

// GREEN SHADE
var color1 = d3.scale.threshold()
  .domain([10000, 100000, 500000, 1000000, 5000000, 10000000, 50000000, 100000000, 500000000, 1500000000, 1700000000])
  .range(["rgb(247, 252, 245)", "rgb(229, 245, 224)", "rgb(199, 233, 192)", "rgb(161, 217, 155)", "rgb(116, 196, 118)", "rgb(65, 171, 93)", "rgb(35, 139, 69)", "rgb(0, 109, 44)", "rgb(0, 90, 36)", "rgb(0, 68, 27)", "rgb(0, 255, 0)"]);
      ...
      .on('mouseout', function (d) {
        ...
        if (sampled_countries.has(populationByName[d.id])) {
          ...
          if (temp_id != ('#country_' + d.id)) {
            ...
            d3.select('#country_' + d.id).style('fill', '#ffc107');
          }
