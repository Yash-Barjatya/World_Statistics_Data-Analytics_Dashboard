...
function enableslider(node) {
  if ($(node).prop("checked") == true) {
    ...
    $(line).css('background-color', '#107c08');
...
// update the list based on checked genders
...
// if main gender box is checked it enables the male and female checkbox
